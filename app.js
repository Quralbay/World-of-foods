...
function fetchCategories() {
  ...
  arr.map(item => {
    categoriesContent.innerHTML += `<div role="status" class="max-w-sm animate-pulse">
    <div class="bg-gray-50 rounded-md dark:bg-gray-300 w-full mb-4 p-4 flex items-center gap-4">
